...
void printList(DynArr *heap)
{
	...
	Task * printTask; // To print descriptions

	// Create and Copy Array
	DynArr *copy = createDynArr(sizeDynArr(heap));
	copyDynArr(heap, copy);

	while (sizeDynArr(copy))
	{
	   printTask = getMinHeap(copy); // Highest current priority
	   printf("%s\n", printTask->description);
	   removeMinHeap(copy); // Move on to next task
	}
