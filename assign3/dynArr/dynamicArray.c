...
{	
	/* FIXME: You will write this function */
        TYPE *newArray = malloc(TYPE_SIZE * newCap);  // Allocate new memory
        assert(newArray != 0);
        ...
        // Free Allocated Memory from unsused array
        free(v->data);

       	// Update Variable Names with new settings
       	v->data = newArray;
        v->capacity = newCap;
}
...
void removeAtDynArr(DynArr *v, int idx)
{
	/* FIXME: You will write this function */
        ...
        // Shift Values to over removed item
        int i;
