...
void _addLinkBefore(struct linkedList *lst, struct DLink *l, TYPE v)
{
	/* FIXME: you must write this */
        ...
        // Assign New Link's value
        newLink->value = v;

        // Assign New Link's pointers
        newLink->next = l;
        newLink->prev = l->prev;

        // Adjust passed in link's pointers
        l->prev->next = newLink;
        l->prev = newLink;
...
TYPE frontList (struct linkedList *lst) {
	...
	return !isEmptyList(lst) ? lst->firstLink->next->value: 0;
}
...
TYPE backList(struct linkedList *lst)
{
	/* FIXME: you must write this */
	/*temporary return value...you may need to change this */
	return !isEmptyList(lst) ? lst->lastLink->prev->value: 0;
}
...
void _printList(struct linkedList* lst)
{
	/* FIXME: you must write this */
        ...
        {
           printf("List Contents: %d ", temp->value);
           temp = temp->next;
        } 
}
